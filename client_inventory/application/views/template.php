...
<body>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="<?= base_url('assets/xtreme_admin_lite/')?>assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                             <!-- Light Logo text -->    
                             <img src="<?= base_url('assets/xtreme_admin_lite/')?>assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= base_url('assets/xtreme_admin_lite/')?>assets/images/users/mhs.png" alt="user" class="rounded-circle" width="31"></a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> 
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onClick="loadMenu('<?= base_url('barang')?>')" aria-expanded="false">
								<i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Barang</span>
							</a>
						</li>
                        <li class="sidebar-item"> 
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onClick="loadMenu('<?= base_url('departemen')?>')" aria-expanded="false">
								<i class="mdi mdi-account-network"></i><span class="hide-menu">Departemen</span>
							</a>
						</li>
                        <li class="sidebar-item"> 
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onClick="loadMenu('<?= base_url('pengadaan')?>')" aria-expanded="false">
								<i class="mdi mdi-border-all"></i><span class="hide-menu">Pengadaan</span>
							</a>
						</li>
                        <li class="sidebar-item"> 
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onClick="loadMenu('<?= base_url('peminjaman')?>')" aria-expanded="false">
								<i class="mdi mdi-face"></i><span class="hide-menu">Peminjaman</span>
							</a>
						</li>
                        <li class="sidebar-item"> 
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onClick="loadMenu('<?= base_url('pengembalian')?>')" aria-expanded="false">
								<i class="mdi mdi-file"></i><span class="hide-menu">Pengembalian</span>
							</a>
						</li>
                        <li class="sidebar-item"> 
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onClick="loadMenu('<?= base_url('laporantahunan')?>')" aria-expanded="false">
								<i class="mdi mdi-alert-outline"></i><span class="hide-menu">Laporan Tahunan</span></a>
							</li>
                        <li class="sidebar-item"> 
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onClick="loadMenu('<?= base_url('laporanstok')?>')" aria-expanded="false">
								<i class="mdi mdi-alert-outline"></i><span class="hide-menu">Laporan Stok</span>
							</a>
						</li>
    ...
    <script src="<?= base_url('assets/xtreme_admin_lite/')?>assets/libs/popper.js/dist/popper.min.js"></script>
