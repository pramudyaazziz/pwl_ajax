...
<body>
	...
	<script src="<?= base_url('assets/xtreme_admin_lite/')
	...
	<script type="text/javascript">
		...
		function checkLogin() {
			var link = "http://localhost/pwl_ajax/backend_inventory/user/check_login/";
			var dataForm = {};
		...
		function setSession(user) {
			var link = "http://localhost/pwl_ajax/client_inventory/index.php/login/setSession";
			var dataForm = {};
			...
			$.ajax(link, {
				...
				data: dataForm,
				success: function(data, status, xhr) {
					location.replace('http://localhost/pwl_ajax/client_inventory/index.php/home');
				},
				error: function(jqXHR, textStatus, errorMsg) {
					alert('Error : ' + errorMsg);
				}
