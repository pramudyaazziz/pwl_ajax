...
class Barang extends CI_Controller
{
	...
	{
		$data_barang = $this->barang->get_barang();
	...
	public function create_action()
	{
		...
		$this->barang->insert_data($arr_input);
	...
	public function update_action()
	{
		...
		$this->barang->update_data($id_barang, $arr_input);
		if ($_FILES != null) {
			$this->upload_foto($id_barang, $_FILES);
		}
		if ($this->db->trans_status() === FALSE) {
	...
	public function detail()
	{
		...
		$data_detail = $this->barang->get_by_id($id_barang);
	...
	public function delete_data()
	{
		$this->db->trans_start();
		$id_barang = $this->input->get('id_barang');
		$this->barang->hapus_data($id_barang);
	...
	public function soft_delete_data()
	{
		$this->db->trans_start();
		$id_barang = $this->input->get('id_barang');
		$this->barang->soft_delete_data($id_barang);
	...
	public function cari_barang()
	{
		...
		$data_barang = $this->barang->get_barang($cari_nama, $cari_deskripsi, $cari_stok);
	...
	private function upload_foto($id_barang, $files)
	{
		...
		if ($this->upload->do_upload('file')) {
			...
			$this->barang->update_data($id_barang, $data_barang);
